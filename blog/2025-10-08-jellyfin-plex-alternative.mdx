...
<Trees title="media/">
  <Folder label="movies" expanded>
    <Folder label="Movie Name (2024)" expanded>
      <File label="Movie Name (2024).mkv" />
      <File label="Movie Name (2024).srt" />
    </Folder>
    <Folder label="Another Movie (2023)" expanded>
      <File label="Another Movie (2023).mp4" />
    </Folder>
  </Folder>
  <Folder label="tv" expanded>
    <Folder label="Show Name (2020)" expanded>
      <Folder label="Season 01" expanded>
        <File label="Show Name - S01E01 - Episode Title.mkv" />
        <File label="Show Name - S01E02 - Episode Title.mkv" />
      </Folder>
      <Folder label="Season 02" expanded>
        <File label="Show Name - S02E01 - Episode Title.mkv" />
      </Folder>
    </Folder>
  </Folder>
  <Folder label="music" expanded>
    <Folder label="Artist" expanded>
      <Folder label="Album (Year)" expanded>
        <File label="01 - Track Name.flac" />
        <File label="02 - Track Name.flac" />
        <File label="cover.jpg" />
      </Folder>
    </Folder>
  </Folder>
</Trees>
