...
description: Guide for setting up PostHog analytics in Docusaurus including configuration, environment variables, and privacy considerations.
...
### 2. 2. 2. Add Environment Variable
