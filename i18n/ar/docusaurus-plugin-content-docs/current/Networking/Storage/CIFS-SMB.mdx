...
# Install Samba serversudo apt install samba samba-common-bin# Install additional utilitiessudo apt install cifs-utils# Start and enable Samba servicessudo systemctl start smbd
sudo systemctl enable smbd
sudo systemctl start nmbd
sudo systemctl enable nmbd# Check service statussudo systemctl status smbd
...
# Install CIFS utilitiessudo yum install cifs-utils# Start and enable Samba servicessudo systemctl start smb
sudo systemctl enable smb
sudo systemctl start nmb
sudo systemctl enable nmb# Check service statussudo systemctl status smb
