...
cat > .env << EOL
# IMPORTANT: THESE ARE PLACEHOLDER VALUES FOR LOCAL DEVELOPMENT ONLY
# DO NOT USE IN PRODUCTION AND DO NOT COMMIT THIS FILE
# These are not real keys and have no sensitive information
ALGOLIA_APP_ID=PLACEHOLDER_NOT_REAL
ALGOLIA_API_KEY=PLACEHOLDER_NOT_REAL
ALGOLIA_INDEX_NAME=PLACEHOLDER_NOT_REAL
POSTHOG_API_KEY=PLACEHOLDER_NOT_REAL
MENDABLE_KEY=PLACEHOLDER_NOT_REAL
EOL
