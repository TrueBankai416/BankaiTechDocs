...
description: Comprehensive collection of Nginx reverse proxy configuration examples for popular applications including Nextcloud, Jellyfin, Home Assistant, and more.
image: /img/social/Examples/nginx-configuration-examples-dark.png
tags: [Reverse Proxy, Nginx, Nextcloud, Adguard Home, Authelia, HomeBridge, Home Assistant, Jellyfin | JFA-GO, Jellyseerr, Arr Suite, Radarr, Sonarr, Prowlarr, Lidarr, Immich, Portainer, Vaultwarden, Uptime Kuma, Snippets]
...
updates:
  - date: 2026-01-30
    note: "docs: comment out Authelia location block includes in Nginx examples"
  - date: 2026-01-30
    note: "docs: clarify Nginx configuration file references and emphasize security considerations"
  - date: 2026-01-30
    note: "docs: enhance Nginx documentation with configuration file guidance and snippet references"
  - date: 2026-01-01
    note: "Standardize HTTP redirect blocks and fix example snippet"
  - date: 2026-01-01
    note: "Refactor Nginx configuration to use dynamic host redirection for HTTP to HTTPS"
---
...
```nginx title="Save as /etc/nginx/snippets/enhanced-proxy-no-limits.conf" showLineNumbers
...
```nginx title="Save as /etc/nginx/snippets/jellyfin-proxy.conf" showLineNumbers
