...
tags:
   ...
   - Prowlarr
   - Lidarr
keywords: [Reverse Proxy,Nginx,Nextcloud,Adguard,Authelia,HomeBridge,Home Assistant,Jellyfin,JFA-GO,Jellyseer,Radarr,Sonarr,Prowlarr,Lidarr,Arr Suite]
last_update:
  author: BankaiTech
---
...
// highlight-end
    ...
    location / {
        ...
        proxy_set_header Connection "upgrade";
// highlight-next-line
        proxy_pass http://192.168.8.157:8123;
        proxy_read_timeout 300s;
        #Cache
        proxy_buffering on;
        proxy_cache_valid 200;
...
// highlight-end
    ...
    location / {
        ...
        proxy_set_header Connection "upgrade";
// highlight-next-line
        proxy_pass http://192.168.8.57:5055;
        proxy_read_timeout 300s;
    }
    location /authelia {
        internal;
...
// highlight-end
    ...
    location / {
// highlight-next-line
        proxy_pass http://192.168.4.109:8091;
        client_body_buffer_size 128k;
        proxy_next_upstream error timeout invalid_header http_500 http_502 http_503;
        send_timeout 5m;
        proxy_read_timeout 360;
