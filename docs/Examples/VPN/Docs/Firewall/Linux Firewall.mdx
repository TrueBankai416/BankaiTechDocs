...
# Block traffic to/from your public IP (replace <PUBLIC_IP> with your actual public IP)
...
sudo ufw allow out to 185.203.219.0/24 proto udp port 1194
sudo ufw allow out to 89.187.160.0/24 proto udp port 1194
sudo ufw allow out to 194.127.199.0/24 proto udp port 1194
```
