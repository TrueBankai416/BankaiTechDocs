...
updates:
  - date: 2025-08-14
    note: "Remove 1194/udp reference and add tip for viewing comments"
  - date: 2025-08-14
    note: "Fix local network rule to match status example output"
  - date: 2025-08-14
    note: "Add comments to UFW command examples"
  - date: 2025-08-14
    note: "Fix inconsistencies between commands and status example"
  - date: 2025-08-14
    note: "Remove generic 1194/udp rule and extra NordVPN server IPs"
---
