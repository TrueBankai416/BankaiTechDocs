...
```
  ...
  <TabItem value="collabora" label="Install with Collabora Code">
    PlaceHolder
  </TabItem>
  <TabItem value="memories" label="Install with Memories">
    Coming Soon
  </TabItem>
  <TabItem value="memories-office" label="Install with Memories & Office">
    Coming Soon
  </TabItem>
</Tabs>
