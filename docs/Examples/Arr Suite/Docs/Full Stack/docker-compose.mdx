...
updates:
  ...
  - date: 2026-02-06
    note: "fix: update docker-compose configuration for jellyfin service with additional settings and volume mappings"
  - date: 2025-08-23
    note: "Add Flaresolverr service to docker-compose example"
  - date: 2025-08-23
    note: "Fix docker-compose volume mappings and dependencies"
  - date: 2025-08-23
    note: "Update media flow example to include Usenet and mergerfs integration"
---
