...
flowchart TD
    ...
    %% Styling
    classDef requestFlow fill:#e1f5fe
    classDef arrSuite fill:#f3e5f5
    classDef downloadFlow fill:#e8f5e8
    classDef processFlow fill:#fff3e0
    classDef finalFlow fill:#fce4ec
