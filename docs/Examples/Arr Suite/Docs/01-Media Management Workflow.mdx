...
flowchart TD
    ...
    class G,H,I,J downloadFlow
    class L,M,N,O,R,S,T,U storageFlow
    class P,Q finalFlow
```
...
└── watch/          # Watch folders for manual additions
...
Ensure your *Arr containers mount the mergerfs pool:

```yaml
volumes:
  - /media/merged:/media  # mergerfs mount point
