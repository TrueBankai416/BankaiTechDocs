...
updates:
  - date: 2026-04-22
    note: "Add mount option reference table and cache.files/umask callouts"
  - date: 2026-04-22
    note: "Update mergerfs fstab: cache.files=partial, umask=002 to fix torrent 'no such device' errors"
  - date: 2026-02-13
  ...
  - date: 2025-08-23
    note: "Final cleanup: fix Mermaid classes and folder structure"
---
