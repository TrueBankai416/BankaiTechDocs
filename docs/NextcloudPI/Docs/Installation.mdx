---
title: Installation
description: Step-by-step guide for installing NextcloudPI on Raspberry Pi using the pre-built image and Etcher, including initial configuration and setup.
image: /img/social/nextcloudpi-social.jpg
tags: [NextcloudPI, Raspberry Pi, Installation, Tutorial]
keywords: [NextcloudPI, Raspberry Pi, Installation, Etcher, Setup]
last_update:
  author: BankaiTech
updates:
---
