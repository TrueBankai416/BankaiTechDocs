...
description: NextcloudPi is a spin-off of the Nextcloud project, optimized for deployment on Raspberry Pi with simplified installation and management tools.
image: /img/social/nextcloudpi-social.jpg
tags: [Docker, Docker Compose, Tutorial, Nextcloud Pi]
...
#### _Running the Installer Script_
