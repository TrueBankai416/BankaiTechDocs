...
keywords: [Proxmox, Storage, NFS, CIFS, SMB, SSHFS, Network Storage, Remote Storage]
last_update:
  author: BankaiTech
---
...
Proxmox VE provides extensive support for various storage backends, enabling administrators to integrate network-attached storage (NAS) solutions seamlessly into their virtualized infrastructure. This guide covers the three most common network storage protocols: NFS, CIFS/SMB, and SSHFS.
