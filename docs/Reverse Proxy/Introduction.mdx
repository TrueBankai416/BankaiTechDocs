...
```mermaid
graph TD
    A[Client Browser<br/>203.0.113.45] -->|1. HTTPS Request<br/>app.example.com:443| B[Reverse Proxy<br/>198.51.100.10<br/>Ports 80, 443]
    B -->|2. Forward<br/>192.168.1.100:3000| C[Web App<br/>192.168.1.100:3000]
    C -->|3. Response| B
    B -->|4. HTTPS Response| A
    ...
    subgraph "Private Network 192.168.1.0/24"
        B
        C
        D[API Server<br/>192.168.1.101:3001]
        E[Database Interface<br/>192.168.1.102:8081]
    end
...
**IP Address Details:**
- **Public IP**: 198.51.100.10 (Reverse Proxy Server)
