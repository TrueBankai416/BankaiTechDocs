...
updates:
  - date: 2025-07-27
    note: "Fix network topology to show proper segmentation"
  - date: 2025-07-27
    note: "Fix mermaid diagram arrow labels causing parsing errors"
  - date: 2025-07-27
    note: "Create simpler, more readable reverse proxy diagrams"
  - date: 2025-07-27
    note: "Simplify reverse proxy diagram for better readability"
  - date: 2025-07-27
    note: "Add comprehensive reverse proxy network flow diagram"
---
...
```mermaid
graph TD
    Client -->|DNS Query| DNS[DNS Server]
    DNS -->|Returns 198.51.100.10| Client
    Client -->|HTTPS app.example.com:443| Proxy[Reverse Proxy<br/>Public: 198.51.100.10<br/>Private: 192.168.1.23]
    Proxy -->|HTTP 192.168.1.100:3000| Backend[Backend Service<br/>192.168.1.100:3000]
...
graph TB
    ...
    subgraph "Network 192.168.1.0/24"
        Proxy[Reverse Proxy<br/>Public: 198.51.100.10<br/>Private: 192.168.1.23]
    end
...
## **_Types of Reverse Proxies and Comparison_**
