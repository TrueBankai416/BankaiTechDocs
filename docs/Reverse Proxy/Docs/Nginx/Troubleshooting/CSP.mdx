...
tags: [Reverse Proxy, Nginx, CSP, Content Security Policy, Troubleshooting]
keywords: [Reverse Proxy, CSP, Content Security Policy, Nginx, External Services, Web Security]
last_update:
  author: BankaiTech
updates:
  - date: 2025-07-19
    note: "Fix CSP errors for Discord comments integration"
  - date: 2025-07-14
    note: "Add Nextcloud CSP troubleshooting example"
  - date: 2025-05-27
    note: "Fix CSP blocking Giscus comments"
  - date: 2025-05-26
    note: "Reorganize CSP docs to Nginx Troubleshooting section"
  - date: 2025-05-26
    note: "Move CSP documentation to Reverse Proxy section"
---
...
## **_Docusaurus CSP Configuration (GitHub Pages)_**
