...
description: Guide for migrating Docusaurus sites via GitHub repository including SSH key setup, Git configuration, and dependency installation.
image: /img/social/docusaurus-social.jpg
sidebar_position: 2
tags: [Docusaurus, Migration]
