...
keywords: [Docusaurus, CSP, Content Security Policy, Nginx, PostHog, Mendable, Buy Me A Coffee]
last_update:
  author: BankaiTech
---
...
Content-Security-Policy: The page's settings blocked the loading of a resource (connect-src) at https://api.mendable[.]ai/v1/initializeMendable
```
...
- **Mendable AI Search**: `api.mendable[.]ai`
...
- External APIs like Mendable AI and PostHog
...
4. **Test functionality**:
   - Search should work (Mendable AI)
