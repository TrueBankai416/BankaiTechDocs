...
description: Comprehensive guide to Docusaurus code blocks including syntax highlighting, line numbers, highlighting, titles, and customization options.
image: /img/social/docusaurus-social.jpg
tags: [Docusaurus, Styling, Code, Syntax Highlighting]
keywords: [Docusaurus, Code blocks, Syntax highlighting, Prism, Programming]
last_update:
  author: BankaiTech
updates:
  - date: 2026-02-13
    note: "Remove stray fence after Codeblocks Trees conversion"
  - date: 2026-02-13
    note: "Convert Codeblocks project tree example to Trees component"
  - date: 2025-07-13
    note: "Update line highlighting to use recommended comment-based approach"
  - date: 2025-07-13
...
<Trees title="my-project">
  <Folder label="src" expanded>
    <Folder label="components" expanded>
      <File label="Header.jsx" />
    </Folder>
    <Folder label="pages" expanded>
      <File label="Home.jsx" />
    </Folder>
    <File label="index.js" />
  </Folder>
  <Folder label="public" expanded>
