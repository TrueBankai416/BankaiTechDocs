...
description: Complete guide for installing and configuring Algolia DocSearch for Docusaurus including API setup, environment variables, and crawler configuration.
image: /img/social/docusaurus-social.jpg
tags: [Docusaurus, Algolia Search]
...
### **_Applying to the DocSearch Program_**

Lets apply for [Algolia DocSearch](https://docsearch.algolia.com/apply/)

:::note
After clicking the link above and signing up, you should receive an Email with further instructions and a Crawler should have been [automatically setup for you](https://docsearch.algolia.com/docs/templates/#getting-started).
...
#### **_Configuring dotenv_**

Open `docusaurus.config.ts using your preferred text editor such as nano.
