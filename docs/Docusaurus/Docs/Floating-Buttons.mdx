...
tags: [Docusaurus, React, Components, UI]
keywords: [Docusaurus, Floating Buttons, React, Components, UI, Theme Swizzling]
updates:
  - date: 2025-12-19
    note: "Fix wording for TOC overlap issue description"
  - date: 2025-12-19
    note: "fix: add instructions to prevent TOC from overlapping floating buttons"
  - date: 2025-08-23
    note: "Remove unused import from Footer wrapper example"
  - date: 2025-08-23
    note: "Add comprehensive floating buttons documentation for Docusaurus"
---
