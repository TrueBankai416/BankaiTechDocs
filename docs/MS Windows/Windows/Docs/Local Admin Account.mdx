...
description: How to create a local administrator account on Windows using Command Prompt — a safe fallback before making changes that affect Microsoft Account authentication.
image: /img/social/windows-local-admin-social.svg
