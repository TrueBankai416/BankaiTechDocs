...
description: Step-by-step guide to activate Windows using a local KMS server on your network with slmgr commands.
image: /img/social/kms-activate-windows-social.svg
tags: [Windows, KMS]
