...
description: Learn how Microsoft's Key Management Service (KMS) works for activating Windows and Office at scale on a local network.
image: /img/social/kms-intro-social.svg
