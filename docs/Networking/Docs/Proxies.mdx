...
tags: [Networking, Proxies, SOCKS, HTTP Proxy, Redsocks, Squid, Security, Anonymity]
keywords: [proxy, redsocks, squid, dante, socks proxy, http proxy, transparent proxy, iptables, networking, anonymity]
last_update:
  author: BankaiTech
updates:
  - date: 2025-06-21
    note: "Add comprehensive Tor documentation to proxy guide"
  - date: 2025-06-21
    note: "Add comprehensive proxy documentation to Networking section"
---
