...
tags: [Networking, Subnets, IP Addressing, CIDR, Network Design, Subnet Masks]
keywords: [subnets, subnet masks, CIDR, IP addressing, network segmentation, subnetting, network design, routing]
last_update:
  author: BankaiTech
updates:
  - date: 2025-12-18
    note: "Improve technical accuracy of /31 subnet note per RFC 3021"
  - date: 2025-09-25
    note: "Add final clarifying note for private IP ranges table"
  - date: 2025-09-25
    note: "Final clarity improvements to subnet documentation"
  - date: 2025-09-25
    note: "Fix private IP address CIDR notation inconsistency"
  - date: 2025-09-25
    note: "Add comprehensive subnet quick reference cheat sheet"
---
...
_Note: The "CIDR" column shows the CIDR notation for each private address block (for example, 172.16.0.0/12 covers 172.16.0.0–172.31.255.255), while "Classful Default Mask" refers to the traditional class-based default subnet masks._
...
_Note: "Subnets (from /24)" shows how many equal subnets you get when splitting a /24 network into the indicated prefix length._
