...
updates:
  - date: 2025-09-20
    note: "Add specific Nextcloud Memories social image"
  - date: 2025-09-20
    note: "Standardize paths to match existing documentation conventions"
  - date: 2025-09-20
    note: "Add path flexibility and Preview Generator app dependency info"
  - date: 2025-09-20
    note: "Improve safety and robustness of preview directory removal steps"
  - date: 2025-09-20
    note: "Fix unrelated package-lock.json changes and improve consistency"
---
