...
updates:
  - date: 2026-08-07
    note: "fix(talk-recording): consolidate duplicate [signaling] sections in server.conf example"
  - date: 2026-08-07
    note: "fix(talk-recording): build from source instead of non-existent ghcr.io image"
  - date: 2026-08-07
