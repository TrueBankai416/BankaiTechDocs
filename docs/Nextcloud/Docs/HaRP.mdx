...
updates:
  - date: 2026-08-07
    note: "fix(harp): add nextcloud network to appapi-harp service"
  - date: 2026-08-07
    note: "docs(harp): add HaRP as service to existing Nextcloud docker-compose instead of separate stack"
  - date: 2026-08-07
