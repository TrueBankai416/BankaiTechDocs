...
:::warning[Recognize App]
At the time of this tuturial, the APT keys for the Recognize App library was depreciated meaning you cannot use Recognize.\
The lines for installation in the Dockerfile are commented out. I will update the Dockerfile when this issue is fixed.\
You can follow the issue [Here](https://github.com/matiasdelellis/facerecognition/issues/731)
:::
...
```
cd /var/docker/nextcloud
wget https://raw.githubusercontent.com/TrueBankai416/BankaiTechDocs/main/Files/Nextcloud/Memories/.nextcloud.env
wget https://raw.githubusercontent.com/TrueBankai416/BankaiTechDocs/main/Files/Nextcloud/Memories/.mariadb.env
wget https://raw.githubusercontent.com/TrueBankai416/BankaiTechDocs/main/Files/Nextcloud/Memories/.collabora.env
wget https://raw.githubusercontent.com/TrueBankai416/BankaiTechDocs/main/Files/Nextcloud/Memories/.go_vod.env
nano .mariadb.env
```
...
```
wget https://raw.githubusercontent.com/TrueBankai416/BankaiTechDocs/main/Files/Nextcloud/Memories/Dockerfile \
wget https://raw.githubusercontent.com/TrueBankai416/BankaiTechDocs/main/Files/Nextcloud/Memories/supervisord.conf \
...
```
wget https://raw.githubusercontent.com/TrueBankai416/BankaiTechDocs/main/Files/Nextcloud/Memories/docker-compose.yaml
nano docker-compose.yaml
```
