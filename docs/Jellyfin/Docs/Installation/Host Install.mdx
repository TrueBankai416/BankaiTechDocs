...
description: Step-by-step guide for installing Jellyfin media server directly on Ubuntu host system with configuration and firewall setup.
image: /img/social/jellyfin-social.webp
tags: [Jellyfin, Media Server, Ubuntu Host]
...
### _Step 2: Install Jellyfin_

To simplify deployment and help automate this for as many users as possible, Jellyfin provides a BASH script to handle repo installation as well as installing Jellyfin. All you need to do is run this command on your system (requires curl, or substitute curl with wget -O-):

```bash
curl https://repo.jellyfin.org/install-debuntu.sh | sudo bash
```

### _Step 3: Access Jellyfin_
...
### _Step 5: Complete the Setup Wizard_
