...
description: Complete guide to integrating TinyMediaManager with Jellyfin for enhanced metadata management, artwork, and media library organization.
image: /img/social/jellyfin-social.webp
tags: [Jellyfin, Media Server, TinyMediaManager, TMM, Metadata]
keywords: [Jellyfin, Media Server, TinyMediaManager, TMM, Metadata]
last_update:
  author: BankaiTech
updates:
  - date: 2025-07-17
    note: "Add TinyMediaManager integration documentation for Jellyfin"
---
