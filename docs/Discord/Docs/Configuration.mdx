---
title: Configuration
description: Configure Discord comment systems in Docusaurus including Giscus integration, environment variables, and dynamic configuration options.
image: /img/social/discord-social.jpg
sidebar_position: 4
updates:
  - date: 2025-07-18
    note: "Fix client-side process.env reference causing page crash"
  - date: 2025-07-18
