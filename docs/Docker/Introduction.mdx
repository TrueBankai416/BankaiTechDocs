...
The `pull_policy` feature requires **Docker Compose V2** (docker compose). For the most up-to-date information, refer to the [official Docker Compose specification](https://docs.docker.com/compose/compose-file/05-services/#pull_policy).
:::
