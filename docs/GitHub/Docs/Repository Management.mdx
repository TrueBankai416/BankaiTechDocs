  ...
  <TabItem value="structure">
    **Standard Repository Structure:**
    <Trees title="my-project">
      <Folder label=".github" expanded>
        <Folder label="workflows" badge="GitHub Actions" />
        <Folder label="ISSUE_TEMPLATE" badge="Issue templates" />
        <File label="PULL_REQUEST_TEMPLATE.md" />
      </Folder>
      <Folder label="docs" badge="Documentation" />
      <Folder label="src" badge="Source code" />
      <Folder label="tests" badge="Test files" />
      <File label=".gitignore" badge="Git ignore rules" />
      <File label="README.md" badge="Project overview" />
      <File label="LICENSE" badge="License file" />
      <File label="package.json" badge="Dependencies (for Node.js)" />
    </Trees>
