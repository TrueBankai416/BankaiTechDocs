...
tags: [GitHub, Repository, Management, Settings, Permissions]
keywords: [GitHub, Repository, Management, Settings, Permissions, Branches, Security]
last_update:
  author: BankaiTech
updates:
  - date: 2026-02-13
    note: "Add docs-only frontmatter changelog component"
  - date: 2026-02-13
    note: "Add Iconify mode support to Trees component"
  - date: 2025-06-23
    note: "Fix HTML tags in Repository Management.mdx - convert to proper Markdown syntax"
  - date: 2025-06-23
  ...
  <TabItem value="structure">
    **Standard Repository Structure:**
    <Trees title="my-project">
      <Folder label=".github" icon="vscode-icons:default-folder" expanded>
        <Folder label="workflows" icon="vscode-icons:folder-type-github" badge="GitHub Actions" />
        <Folder label="ISSUE_TEMPLATE" icon="vscode-icons:default-folder" badge="Issue templates" />
        <File label="PULL_REQUEST_TEMPLATE.md" icon="vscode-icons:file-type-markdown" />
      </Folder>
      <Folder label="docs" icon="vscode-icons:folder-type-docs" badge="Documentation" />
      <Folder label="src" icon="vscode-icons:folder-type-src" badge="Source code" />
      <Folder label="tests" icon="vscode-icons:folder-type-test" badge="Test files" />
      <File label=".gitignore" icon="vscode-icons:file-type-git" badge="Git ignore rules" />
      <File label="README.md" icon="vscode-icons:file-type-readme" badge="Project overview" />
      <File label="LICENSE" icon="vscode-icons:file-type-license" badge="License file" />
      <File label="package.json" icon="vscode-icons:file-type-node" badge="Dependencies (for Node.js)" />
    </Trees>
